...
export default async function (ownerAddress, additionalConfigs = {}) {
    ...
    try {
        ...
        const availableNfts = await contract.tokensOfOwner(ownerAddress);

        return availableNfts;
    } catch (error) {
        console.error("[PTE] ERROR: cannot check the owner nfts, reason: ");
        console.error(error);
        return null;
    }
}